...
\part{Bible Haptique\\ R\'esum\'e des connaissances}
	...
	\input{1_Bible/Chapters/1_Sens_Sensation_Perception/0.Sens_Sensation_Perception}
	\input{1_Bible/Chapters/2_Sensation_Tactile/0.Sensation_Tactile}
	\input{1_Bible/Chapters/3_Perception_Tactile/0.Perception_Tactile}
	\input{1_Bible/Chapters/4_Haptique_et_Technologie/0.Haptique_et_Technologie}
	\input{1_Bible/Chapters/5_La_Peau/0.La_Peau}
	\input{1_Bible/Chapters/6_Le_Systeme_Nerveux/0.Le_Systeme_Nerveux}
	

\part{Fiches des articles}
	\chapter{Biom\'{e}canique}
		\input{2_Fiche_lecture/Articles/2012-Adams/2012-Adams}

\appendix

\input{1_Bible/Chapters/appTest}
