...
\part{Bible Haptique\\ R\'esum\'e des connaissances}
	...
	\input{1_Bible/Chapters/leSn}
	\input{1_Bible/Chapters/laPeau}
	\input{1_Bible/Chapters/sensPerception}
	\input{1_Bible/Chapters/sensationTactile}
	\input{1_Bible/Chapters/perceptionTactile}
	\input{1_Bible/Chapters/technologies}
	\input{1_Bible/Chapters/equipementAcqui}
