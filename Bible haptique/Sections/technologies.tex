...
\begin{figure}[!h]
	\centering
	\includegraphics[width=6cm]{Photos/mid_air_disney.jpg}\hspace{2cm}
	\includegraphics[width=6cm]{Photos/mid_air_jet.jpg}
	\caption{Interfaces à retour tactile par contact indirect : a) ... }\label{int_retourid_1}
\end{figure}
\begin{figure}[!h]
	\centering
	\includegraphics[width=7cm]{Photos/mid_air_ultrahaptics.jpg}
